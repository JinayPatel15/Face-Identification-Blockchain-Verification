...
class CandidateFaceMatcher:
    ...
    def verify_candidate(
        ...
        Returns:
            CandidateMatch containing similarity score and acceptance decision.
        """
        ...
        # Obtain candidate image
        img = candidate_image
        if img is None:
            # Try thumbnail first, fallback to URL
            img_src = norm_res.thumbnail or norm_res.url
        ...
        if img is None:
            return CandidateMatch(
                ...
                is_match=False,
                face_detected=False,
                error="Could not download or decode candidate image.",
            )
